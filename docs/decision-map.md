...
| [0003](adr/0003-risk-based-oss-security-governance.md) | Risk-based OSS security/governance | [Security](security.md), [Maintainer Governance](maintainer-governance.md), [Security Exceptions](security-exceptions.md) | risk-based controls and exception records |
