...
| [0003](adr/0003-risk-based-oss-security-governance-ko.md) | Risk 기반 OSS Security/Governance | [Security](security-ko.md), [Maintainer Governance](maintainer-governance-ko.md), [Security Exceptions](security-exceptions-ko.md) | Risk-based Control 및 Exception Record |
